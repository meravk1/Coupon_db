...
public class Visitor extends Volunteer{
   ...
   /* public Visitor(PersonalDetails p, boolean catches, int basisBonus, Days day, States state) {
    ...
    public Visitor(PersonalDetails p, boolean catches, int basisBonus, Days day, States state, String password, String email) {
        super(p, catches, basisBonus, day,password,email);
        this.state = state;
    }
